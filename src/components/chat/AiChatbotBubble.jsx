...
const AiChatbotBubble = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end pointer-events-none">
      ...
      >
        {!isOpen && (
          <span className="absolute right-[82px] top-3 w-max max-w-[180px] rounded-2xl rounded-br-sm bg-white px-3 py-2 text-xs font-semibold text-slate-700 shadow-xl border border-slate-200 opacity-0 translate-y-1 transition-all group-hover:opacity-100 group-hover:translate-y-0">
            Cần hỗ trợ tìm việc?
          </span>
        )}
