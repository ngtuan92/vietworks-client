    ...
    <aside className="w-full lg:w-1/4 space-y-6">
      <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
        <div className="flex items-center justify-between mb-6">
          ...
          <button className="text-primary text-sm font-semibold hover:underline">Xóa tất cả</button>
        </div>
        ...
        <div className="mb-6">
          ...
          <ul className="space-y-3">
            <li className="flex items-center gap-3">
              <input className="rounded border-gray-300 text-primary focus:ring-[#003f87] h-5 w-5" id="it" type="checkbox" />
              <label className="text-sm text-gray-700 cursor-pointer" htmlFor="it">Công nghệ thông tin</label>
            </li>
            <li className="flex items-center gap-3">
              <input className="rounded border-gray-300 text-primary focus:ring-[#003f87] h-5 w-5" id="marketing" type="checkbox" />
              <label className="text-sm text-gray-700 cursor-pointer" htmlFor="marketing">Marketing / PR</label>
            </li>
            <li className="flex items-center gap-3">
              <input className="rounded border-gray-300 text-primary focus:ring-[#003f87] h-5 w-5" id="sales" type="checkbox" />
        ...
        <div className="mb-6 pt-6 border-t border-gray-100">
          ...
          <ul className="space-y-3">
            <li className="flex items-center gap-3">
              <input className="border-gray-300 text-primary focus:ring-[#003f87] h-5 w-5" id="entry" name="exp" type="radio" />
              <label className="text-sm text-gray-700 cursor-pointer" htmlFor="entry">Mới tốt nghiệp / Entry</label>
            </li>
            <li className="flex items-center gap-3">
              <input className="border-gray-300 text-primary focus:ring-[#003f87] h-5 w-5" id="mid" name="exp" type="radio" />
              <label className="text-sm text-gray-700 cursor-pointer" htmlFor="mid">Nhân viên (2-5 năm)</label>
            </li>
            <li className="flex items-center gap-3">
              <input className="border-gray-300 text-primary focus:ring-[#003f87] h-5 w-5" id="senior" name="exp" type="radio" />
      ...
      <div className="bg-[#d9e3f2] p-6 rounded-xl flex flex-col items-center text-center">
        <ShieldCheck className="text-5xl text-[#131c27] mb-2 w-5 h-5" />
