  ...
  return (
    <div className="bg-gradient-to-br from-[#003f87] to-[#002554] text-white rounded-2xl p-6 shadow-xl relative overflow-hidden group">
      ...
      <div className="relative z-10 flex flex-col h-full justify-between">
        ...
        <button 
          onClick={() => { setIsOpen(true); setActiveResult(null); setActiveTab('new'); }}
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white text-slate-800 rounded-3xl shadow-2xl w-full max-w-5xl h-[88vh] flex flex-col overflow-hidden animate-fade-in animate-duration-200">
