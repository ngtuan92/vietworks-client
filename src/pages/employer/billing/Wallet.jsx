    ...
    <div className="space-y-6">
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <Link to="/employer/wallet/topup" className="px-4 py-2 rounded-xl bg-primary text-white font-bold hover:bg-primary/95 hover:shadow-lg hover:shadow-primary/20 hover:-translate-y-0.5 active:translate-y-0 transition-all">
            Nạp tiền
          </Link>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <Card title="Số dư hiện tại" value="1.250.000 VNĐ" tone="text-primary" />
